        ...
        <Card key={i} className="!p-0 overflow-hidden">
          ...
          {expanded === i && (
            <div className="px-5 pb-5 space-y-4 border-t border-ash-border pt-4">
              ...
              <Field label="Description"><Textarea name={`proj-desc-${i}`} showWordCount value={stripMarkdown(item.description)} onChange={(e) => update(i, { description: stripMarkdown(e.target.value) })} rows={3} placeholder="What it does, scale, outcomes" /></Field>
              <div>
