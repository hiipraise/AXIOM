  ...
  return (
    <section className="relative pt-32 pb-24 px-5 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        >
          <div className="relative aspect-video rounded-2xl bg-ash border border-ash-border overflow-hidden shadow-lg shadow-ink/5">
            <img
              src="/assets/screenshots/hero_cv_editor.png"
              alt="AXIOM CV editor interface — build, tailor, and export your CV"
            ...
            />
            {/* Fallback: neutral background visible when image fails or hasn't been added yet */}
            <div
            ...
            >
              <div className="flex flex-col items-center gap-2">
                ...
                <span>CV editor screenshot</span>
              </div>
            </div>
          </div>
        </motion.div>
