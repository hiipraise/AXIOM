...
import { ArrowRight, Briefcase, ScanSearch, FileSignature } from "lucide-react";

const STEPS = [
  {
    icon: Briefcase,
    label: "Find a role",
    desc: "Browse live jobs matched to your CV skills and target role.",
  },
  {
    icon: ScanSearch,
    label: "Get your score",
    desc: "AI scores your CV against the job. See exactly what's missing.",
  },
  {
    icon: FileSignature,
    label: "Tailor & apply",
    desc: "One click tailors your CV and writes a cover letter. Then apply.",
  },
];
      ...
      <div className="max-w-5xl mx-auto" ref={ref}>
        ...
        >
          ...
          <h2 className="font-display font-bold text-3xl text-ink mb-3">
            AXIOM Jobs — the full loop.
          </h2>
          <p className="text-ink-muted text-sm max-w-md mx-auto leading-relaxed">
            Don't just build a CV. Find the role, score your fit, tailor your
            application, and track every step — all in one place.
          </p>
        </motion.div>
