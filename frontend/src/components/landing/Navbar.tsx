...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile drawer — full screen overlay, fully scrollable */}
      {mobileOpen && (
        <>
          {/* Backdrop */}
          <div
          ...
          {/* Drawer */}
          <div
            className="md:hidden fixed left-0 right-0 bottom-0 bg-white z-50 overflow-y-auto overscroll-contain"
            style={{ top: bannerH + 64 }}
          >
            <div className="px-5 py-4 space-y-1">
              ...
              <div className="border-t border-ash-border pt-3 mt-2 space-y-1">
                ...
                <Link to="/explore" onClick={() => setMobileOpen(false)} className="block px-3 py-2.5 text-sm text-ink-muted rounded-lg hover:bg-ash">Explore CVs</Link>
