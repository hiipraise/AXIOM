  ...
  return (
    <div className="min-h-screen bg-ash px-4 sm:px-6 py-6 sm:py-8">
      <div className="max-w-2xl mx-auto">
        <button
          onClick={() =>
            mode === "choose" ? navigate("/dashboard") : setMode("choose")
          }
            ...
            {[
              {
                ...
                desc: "Fill in each section manually with AI help on demand.",
              },
              {
                m: "upload" as Mode,
                icon: Upload,
                title: "Import existing CV",
                desc: "Upload a PDF — we extract the content and you refine it.",
              },
              {
                m: "interview" as Mode,
                icon: MessageSquare,
                title: "AI Interview mode",
                desc: "Answer questions and we build the CV structure from your responses.",
              },
              ...
              >
                ...
                <ChevronRight
                  size={15}
                  className="text-ink-muted flex-shrink-0 group-hover:text-ink transition-colors"
                />
              </button>
            ))}
          </div>
        ...
        {(mode === "blank" || mode === "upload") && (
          <div className="bg-white rounded-xl border border-ash-border p-4 sm:p-6 space-y-4">
                ...
                {!extractedData ? (
                  ...
                  <div className="flex items-center gap-2 p-3 bg-emerald-50 border border-emerald-200 rounded-lg">
                    ...
                    <span className="text-xs text-emerald-700 font-medium">
                      CV extracted — {extractedData.experience.length}{" "}
            ...
            <button
              onClick={
                mode === "blank" ? handleCreateBlank : handleCreateFromUpload
              }
          ...
          <div className="bg-white rounded-xl border border-ash-border overflow-hidden flex flex-col">
            <div className="px-4 py-3 border-b border-ash-border">
              ...
              <p className="text-xs text-ink-muted">
                Answer naturally — AI gathers your career details
              </p>
            </div>
            ...
            <div className="h-64 sm:h-80 overflow-y-auto p-4 space-y-3">
              {interviewMessages.length === 0 && (
                <p className="text-xs text-ink-muted italic">
                  Start by telling me about yourself — your current role,
                  background, or target job.
                </p>
              )}
            ...
            <div className="border-t border-ash-border p-3 flex gap-2">
              <input
                ...
                onKeyDown={(e) =>
                  e.key === "Enter" && !e.shiftKey && handleInterviewSend()
                }
