    ...
    <div className="bg-ink text-white px-4 py-2.5 flex items-center justify-between gap-3 flex-shrink-0">
      <div className="flex items-center gap-2 text-xs min-w-0">
        ...
        <span className="truncate">
          ...
          <Link to="/register" className="underline font-medium whitespace-nowrap">
            Save free →
          </Link>
        </span>
      </div>
  ...
  return (
    ...
    ">
      ...
      <p className="text-xs text-ink-muted leading-relaxed mb-5">
        Sign up for free to unlock AI chat, auto-generate summaries,
        apply edits, and match your CV to job descriptions.
      </p>
      <Link
        to="/register"
