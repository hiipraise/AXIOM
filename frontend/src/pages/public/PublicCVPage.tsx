      ...
      <div className="min-h-screen bg-ash">
        ...
        >
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span className="font-display font-bold text-ink text-sm hidden sm:block">AXIOM</span>
            <span className="text-ash-border text-xs hidden sm:block">|</span>
          ...
          >
            <Download size={13} />
            <span className="hidden sm:inline">{isPrinting ? 'Preparing…' : 'Download PDF'}</span>
