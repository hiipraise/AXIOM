...
export default function PublicProfilePage() {
  ...
  if (isLoading) return (
    <div className="min-h-screen bg-ash flex items-center justify-center">
      <p className="text-sm text-ink-muted animate-pulse">Loading profile…</p>
    </div>
  )
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-ink-muted">
                      Updated {new Date(cv.updated_at).toLocaleDateString(undefined, { month: 'short', day: 'numeric', year: 'numeric' })}
                    </p>
                  </div>
                </div>
